package com.sapient.automation.webdriver;
...
/*
 * Factory to instantiate a WebDriver object. It returns an instance of the driver (local invocation) or an instance of
 * RemoteWebDriver
 * 
...
public class WebDriverFactory {
    ...
    /*
     * Factory method to return a RemoteWebDriver instance given the url of the Grid hub and a Browser instance.
     * 
    ...
    public static WebDriver getInstance(Browser browser) {
        ...
        return getInstance(browserName, capability);
    }
     ...
     */
    public static WebDriver getInstance(String browser, DesiredCapabilities capability) {
     ...
     * 
     * @param capability : DesiredCapabilities object coming from the selected browser
     * 
